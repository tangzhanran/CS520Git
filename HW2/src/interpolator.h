...
protected:
  ...
  vector Linear(double t, vector pStart, vector pEnd);
  ...
  std::vector<Quaternion<double>> GenerateControlPoints(int boundcondition, Quaternion<double> q0, Quaternion<double> q1, Quaternion<double> q2, Quaternion<double> q3 = Quaternion<double>());
  std::vector<vector> GenerateControlPoints(int boundcondition, vector p0, vector p1, vector p2, vector p3);
};
